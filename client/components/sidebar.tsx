...
export function Sidebar({
  ...
  return (
    <div
      className={cn(
        "flex flex-col h-full w-64 bg-background transition-all duration-300",
...
const SidebarTriggerOriginal = React.forwardRef<
...
export function SidebarTrigger({ children }: { children: React.ReactNode }) {
  const { setIsOpen, isOpen } = React.useContext(SidebarContext);
...
const SidebarHeaderOriginal = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => {
  return (
...
const SidebarContentOriginal = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div">
>(({ className, ...props }, ref) => {
  return (
